          ...
          <div>
            <div>
              ...
              <p className="mt-16 text-2xl max-w-3xl leading-8 text-black ">
                ...
                range from{" "}
                <span className="lg:text-xl text-md font-medium leading-8 text-gray-700 sm:text-center  transition duration-300 ease-in-out border-b-2 border-transparent hover:border-indigo-500">
                  <Link to="/">Web Development</Link>
                </span>
                <span className="mx-1 lg:text-xl text-md font-medium leading-8 text-gray-700 sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-indigo-500">
